    ...
    return (
        <>
            ...
            <div className="h-screen flex flex-col items-center justify-center bg-gradient-to-r from-purple-400 to-pink-400">
                <div className="p-5 border border-cyan-950 text-cyan-800 rounded bg-white">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <button type="button" onClick={handleAdd} className="bg-cyan-500 text-white p-3 rounded-full hover:bg-green-300 hover:text-white">ADD</button>
                        <button onClick={redirectToInventory} className="mt-4 bg-green-400 text-white p-3 rounded-full hover:bg-blue-700"> Back to VJT Shop </button>
                    </div>
